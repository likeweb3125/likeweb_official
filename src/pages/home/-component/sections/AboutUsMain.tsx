...
import arrowWhite from "@/assets/images/arrow_down_head_white.svg";
...
const AboutUsMain = forwardRef<HTMLDivElement, SectionProps>(({ onToggle }, ref) => {
    return (
        <div ref={ref} id="aboutus">
            <Section heading="aboutus" bg={bg} className="p-0 relative flex flex-1 bg-cover" onToggle={onToggle}>
                <div className="flex justify-between flex-1 overflow-x-scroll">
                    <div className="relative pl-[220px] pt-[160px]">
                        ...
                        <button
                            type="button"
                            className="relative overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-[#FD5B1D33] before:animate-fill-bg mt-[180px] w-[110px] h-[110px] p-[5px] rounded-full flex justify-center items-center"
                        >
                            <p className="flex-1 h-full rounded-full bg-[#FD5B1D] flex flex-col items-center justify-center gap-[12px] relative">
                                <span className="text-white text-[18px] font-[600] font-Urbanist">Start!</span>
                                <img src={arrowWhite} alt="start!" width={14} height={14} className="animate-bounce" />
                            </p>
                        </button>
                    </div>

                    <div className="min-w-[1056px] mr-[100px] relative">
                        <ul className="flex h-full absolute top-0 right-0">
